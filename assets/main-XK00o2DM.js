import{as as e,at as o,au as a}from"./index-BIqqI76S.js";const{currentUrl:i}=a.states,r=e({id:"template-id",stacEndpoint:"https://jorop.github.io/eodash-test/template_catalog/catalog.json",brand:{name:"Dashboard",font:{family:"Poppins",link:new URL("data:text/css;base64,QGZvbnQtZmFjZSB7CiAgZm9udC1mYW1pbHk6ICJQb3BwaW5zIjsKICBzcmM6IGxvY2FsKCJQb3BwaW5zIiksIHVybCgiLi9Qb3BwaW5zL1BvcHBpbnMtUmVndWxhci50dGYiKSBmb3JtYXQoIndvZmYiKTsKfQo=",import.meta.url).href},logo:"/logo.png",errorMessage:"something went wrong, please contact demo@email.com if the issue persists",footerText:"eodash instance template",theme:{colors:{primary:"#004170",secondary:"#004170",background:"#fff",surface:"#fff"}}},template:{gap:0,background:{id:Symbol(),type:"internal",widget:{name:"EodashMap",properties:{}}},widgets:[{id:Symbol(),type:"internal",title:"Indicators",layout:{x:0,y:0,w:2,h:8},widget:{name:"EodashItemFilter",properties:{aggregateResults:"collection_group"}}},{id:Symbol(),type:"internal",title:"Layer Control",layout:{x:0,y:6,w:2,h:4},widget:{name:"EodashLayerControl"}},{defineWidget:t=>t?{id:"Information",title:"Information",layout:{x:9,y:0,w:3,h:12},type:"web-component",widget:{link:async()=>await o(()=>import("./eox-stacinfo-CES29oXd.js"),[],import.meta.url),properties:{for:i,allowHtml:"true",styleOverride:`.single-property {columns: 1!important;}
